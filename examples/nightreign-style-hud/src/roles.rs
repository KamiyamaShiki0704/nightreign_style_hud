...
const WYLDER_SKILL_LOCK_MAX_DISTANCE: f32 = 28.0;
const WYLDER_SKILL_LOCK_SCALE_NEAR_DISTANCE: f32 = 5.0;
const WYLDER_SKILL_LOCK_SCALE_NEAR: f32 = 1.70;
const WYLDER_SKILL_LOCK_SCALE_FAR: f32 = 0.60;
const WYLDER_SKILL_LOCK_SCREEN_RADIUS_FACTOR: f32 = 0.12;
const WYLDER_SKILL_LOCK_MAX_DISTANCE_ENTRIES: usize = 160;
const WYLDER_SKILL_LOCK_MIN_WALL_HIT_DISTANCE: f32 = 1.75;
const WYLDER_SKILL_LOCK_WALL_FILTERS: [u32; 9] = SCHOLAR_LINE_OF_SIGHT_FILTERS;
...
const SP_WYLDER_SKILL_LOCK: i32 = 30;
